        ...
        <div className="container">
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-16">
            ...
            <Card className="p-8 text-center">
              ...
              <a href="mailto:info@spinandlearn.com" className="text-primary hover:text-primary/80 transition-colors font-medium">
                Send us an email
              </a>
            </Card>
            ...
            <Card className="p-8 text-center">
              ...
              <a href="tel:+17185550123" className="text-primary hover:text-primary/80 transition-colors font-medium">
                Call us
              </a>
            </Card>
